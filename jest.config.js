module.exports = {
  ...
  moduleNameMapper: {
    ...
    '^@cats4ts/cats-test-kit$': '<rootDir>/cats/test-kit/src',
    '^@cats4ts/cats-test-kit/lib/(.*)$': '<rootDir>/cats/test-kit/src/$1/',
    '^@cats4ts/core$': '<rootDir>/core/src',
    '^@cats4ts/core/lib/(.*)$': '<rootDir>/core/src/$1/',
    '^@cats4ts/effect$': '<rootDir>/effect',
    ...
    '^@cats4ts/effect-laws$': '<rootDir>/effect/laws/src',
    '^@cats4ts/effect-laws/lib/(.*)$': '<rootDir>/effect/laws/src/$1/',
    ...
    '^@cats4ts/stream$': '<rootDir>/stream',
    '^@cats4ts/stream-core$': '<rootDir>/stream/core/src',
    '^@cats4ts/stream-core/lib/(.*)$': '<rootDir>/stream/core/src/$1/',
    '^@cats4ts/stream-test-kit$': '<rootDir>/stream/test-kit/src',
    '^@cats4ts/stream-test-kit/lib/(.*)$': '<rootDir>/stream/test-kit/src/$1/',
  },
};
