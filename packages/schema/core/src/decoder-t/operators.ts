...
export const optional =
  <F>(F: Applicative<F>) =>
  <A>(d: DecoderT<F, unknown, A>): DecoderT<F, unknown, A | undefined> =>
    new DecoderT(i =>
      i === undefined ? DecodeResultT.success(F)(undefined) : d.decodeT(i),
    );
...
export const dimap_ =
  ...
  <II, I, A, B>(
    ...
    new DecoderT(ii => F.map_(d.decodeT(f(ii)), ea => ea.map(g)));
...
export const adaptF_ =
  ...
  <II, I, A>(
    ...
    new DecoderT(ii => F.flatMap_(f(ii), d.decodeT));
...
export const flatMap_ =
  ...
  <I, A, B>(
    ...
    new DecoderT(i =>
      EitherT.Monad<F, DecodeFailure>(F).flatMap_(d.decodeT(i), x =>
        f(x).decodeT(i),
      ),
    );
