...
import { List, View } from '@fp4ts/collections-core';
import {
  MonadPlusSuite,
...
describe('Views', () => {
  describe('construction', () => {
    ...
    it(
      ...
      forAll(CA.fp4tsLazyList(fc.integer()), xs =>
    ...
    it(
      ...
      forAll(CA.fp4tsVector(fc.integer()), xs =>
  ...
  test(
    ...
    forAll(CA.fp4tsView(fc.integer()), xs =>
  ...
  test(
    ...
    forAll(CA.fp4tsView(fc.integer()), fc.func(fc.string()), (xs, left) =>
  ...
  test(
    ...
    forAll(CA.fp4tsView(fc.integer()), fc.func(fc.string()), (xs, right) =>
  ...
  test(
    ...
    forAll(CA.fp4tsView(fc.integer()), fc.integer(), (xs, x) =>
  ...
  describe('all', () => {
    ...
    it(
      'should be List.all',
      forAll(CA.fp4tsView(fc.integer()), fc.func(fc.boolean()), (xs, p) =>
  ...
  test(
    ...
    forAll(CA.fp4tsView(fc.integer()), fc.integer(), (xs, n) =>
  ...
  test(
    ...
    forAll(CA.fp4tsView(fc.integer()), fc.integer(), fc.integer(), (xs, f, t) =>
  ...
  describe('lookup', () => {
    ...
    it(
      ...
      forAll(
        CA.fp4tsView(fc.tuple(fc.string(), fc.integer())),
        fc.string(),
  ...
  describe('get', () => {
    ...
    it(
      ...
      forAll(
        fc
          .tuple(CA.fp4tsView(fc.integer()), fc.integer())
  ...
  describe('getOption', () => {
    ...
    it(
      ...
      forAll(CA.fp4tsView(fc.integer()), fc.integer(), (xs, i) =>
  ...
  test(
    ...
    forAll(CA.fp4tsView(fc.integer()), fc.integer(), fc.integer(), (xs, i, x) =>
      i < 0 || xs.size <= i
  ...
  test(
    ...
    forAll(CA.fp4tsView(fc.integer()), CA.fp4tsView(fc.integer()), (xs, ys) =>
  ...
  test(
    'map to be List.map',
    forAll(CA.fp4tsView(fc.integer()), fc.func(fc.string()), (xs, f) =>
  ...
  describe('map2', () => {
    ...
    it(
      'should be List.map2',
      forAll(CA.fp4tsView(fc.integer()), CA.fp4tsView(fc.string()), (xs, ys) =>
  ...
  describe('flatMap', () => {
    ...
    it(
      ...
      forAll(
        CA.fp4tsView(fc.integer()),
        fc.func(CA.fp4tsView(fc.string())),
        (xs, f) =>
  ...
  test(
    ...
    forAll(CA.fp4tsView(CA.fp4tsView(fc.integer())), xss =>
  ...
  test(
    ...
    forAll(CA.fp4tsView<number | string>(fc.integer()), fc.string(), (xs, x) =>
  ...
  test(
    ...
    forAll(CA.fp4tsView(fc.string()), xs =>
  ...
  describe('distinct to be List.distinct', () => {
    ...
    test(
      'Eq',
      forAll(CA.fp4tsView(fc.tuple(fc.integer(), fc.integer())), xs => {
  ...
  test(
    ...
    forAll(CA.fp4tsView(fc.integer()), fc.func(fc.integer()), (xs, f) =>
      xs.isEmpty
  ...
  test(
    ...
    forAll(CA.fp4tsView(fc.string()), fc.string(), (xs, s) =>
  ...
  test(
    'join to be List.join',
    forAll(CA.fp4tsView(fc.string()), fc.string(), xs =>
...
class ConcatAction<A> extends Action<A, A> {
  ...
  static readonly Arb = CA.fp4tsView(fc.integer()).map(
...
class ZipAction<A, B> extends Action<A, [A, B]> {
  ...
  static readonly Arb = CA.fp4tsView(fc.integer()).map(xs => new ZipAction(xs));
}
class Zip3Action<A, B, C> extends Action<A, [A, B, C]> {
  ...
  static readonly Arb = fc
    .tuple(CA.fp4tsView(fc.integer()), CA.fp4tsView(fc.integer()))
...
class ZipWithAction<A, B, C> extends Action<A, C> {
  ...
  static readonly Arb = fc
    .tuple(CA.fp4tsView(fc.integer()), fc.func(fc.integer()))
...
describe('composition', () => {
  ...
  it(
    ...
    forAll(actionsArb, CA.fp4tsView(fc.integer()), (as, xs) =>
      expect(
