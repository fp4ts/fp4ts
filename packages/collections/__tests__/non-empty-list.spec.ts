...
import { List, NonEmptyList as Nel, Vector } from '@fp4ts/collections';
import {
  AlignSuite,
  CoflatMapSuite,
  MonadSuite,
...
describe('NonEmptyList', () => {
  ...
  test(
    ...
    forAll(
      CA.fp4tsNel(fc.integer()),
      fc.func<[number], Nel<string>>(CA.fp4tsNel(fc.string())),
      (nel, f) =>
        new IsEq(
