...
import { Vector, List } from '@fp4ts/collections';
...
describe('List', () => {
  ...
  describe('concat', () => {
    ...
    test(
      ...
      forAll(CA.fp4tsList(fc.integer()), CA.fp4tsList(fc.integer()), (xs, ys) =>
  ...
  describe('distinct', () => {
    ...
    it(
      ...
      forAll(CA.fp4tsList(fc.string()), xs =>
  ...
  describe('Laws', () => {
    ...
    checkAll(
      'MonadPlus<List>',
      MonadPlusSuite(List.MonadPlus).monadPlus(
        fc.integer(),
        fc.integer(),
        fc.integer(),
        fc.integer(),
