...
// -- https://github.com/immutable-js/immutable-js/blob/main/src/Hash.js
...
function getIENodeHash(node: any) {
...
let UID_HASH_KEY: string | symbol = '__fp4tshash__';
...
let stringHashCache: Record<string, any> = {};
